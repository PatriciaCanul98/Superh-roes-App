...
class _SuperheroSearchScreenState extends State<SuperheroSearchScreen> {
        ...
        children: [
          Padding(
            ...
            child: TextField(
              ...
              // onChanged devuelve el texto que se escribe en el campo de texto
              onChanged: (text) {
                setState(() {
                  _isTextEmpty = text.isEmpty;
                  // Todo esto se asigna al futruro _superheroInfo
                  _superheroInfo = _repository.fectchSuperheroInfo(text);
                });
              },
            ),
          ),
  ...
  // Esto espera a que un futuro tenga información
  // Dice que cuando _superheroInfo tenga información vas a hacer lo de builder
  // snapshot es un objeto que contiene mucha información que se utiloizará
            ...
            ClipRRect(
              ...
              child: Image.network(
                ...
                alignment: Alignment(
                  0,
                  -0.6,
                ), // el x es centrado y la y es la parte superior de la imagen
              ),
            ),
            Padding(
